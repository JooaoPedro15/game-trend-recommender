...
#
# Os espacos sao [ \t] e nunca \s: com \s o rotulo VAZIO roubava a proxima linha da
# descricao. Em 42 videos do canal o autor deixou "Jogo : " em branco, e ali o \s*
# atravessava a linha vazia e capturava o banner seguinte, gravando "JOGOS COM DESCONTO NA
# NUUVEM" como nome do jogo — com confianca alta, ainda por cima. Um rotulo vazio agora
# simplesmente nao casa, e a deteccao segue para as outras fontes, que e onde nesses videos
# o nome de verdade esta: nos comentarios.
PADRAO_EXPLICITO = re.compile(
    r"^[ \t]*(?:jogo|game|nome[ \t]+do[ \t]+jogo)[ \t]*(:|-)[ \t]*(.+?)[ \t]*$",
